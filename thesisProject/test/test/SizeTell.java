...
public class SizeTell {
    ...
    public static void main(String[] args) throws IllegalAccessException {
        System.out.println(SizeTell.sizeOf("a"));
        System.out.println(SizeTell.sizeOf(new int[]{1, 2, 3}));
        System.out.println(SizeTell.sizeOf(new HashMap(512)));
        System.out.println(SizeTell.sizeOf(Integer.valueOf(1)));
    }
