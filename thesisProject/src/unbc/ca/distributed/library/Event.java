...
/**
 * This class represents events which are passed between the entities in the
 * simulation.
 *
 * @see Sim_system
 * @see Sim_entity
...
public class Event implements Cloneable {
    ...
    /**
     * Create a blank event. Useful for fetching events using methods such as
     * the
     * <code>sim_wait()</code> methods of entities.
     *
     */
    public Event() {
        etype = ENULL;
    ...
    public String toString() {
        return "Type:" + etype + ", Time:" + time + ", endWaitingTime: " + end_waiting_time + ", Destination:" + ent_dst
                + ", Source: " + ent_src + ", Tag: " + tag;
    }
     ...
     */
    public boolean from_port(Port p) {
